	    			...
	    			<div class="d-flex justify-content-between pos-header mb-3 p-2">
		    			<div class="logo-img">
		    				<a href="<?php echo e(route('dashboard')); ?>">
				               <img height="30" src="<?php echo e(asset('img/logo.png')); ?>" class="header-brand-img" title="RADMIN"> 
				           </a>
			            </div>
		    			<div class="top-menu d-flex justify-content-right">
		    				<a href="<?php echo e(url('dashboard')); ?>" class="nav-link ml-10" ><i class="ik ik-globe"></i></a>
		    				<button type="button" class="nav-link ml-10" id="apps_modal_btn" data-toggle="modal" data-target="#appsModal"><i class="ik ik-grid"></i></button>
			                <div class="dropdown">
			                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="<?php echo e(asset('img/user.jpg')); ?>" alt=""></a>
...
</html><?php /**PATH D:\server\htdocs\laravel-demo\resources\views/inventory/pos.blade.php ENDPATH**/ ?>