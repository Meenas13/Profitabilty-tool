<footer class="footer">
    <div class="w-100 clearfix">
        ...
        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">
        	<span class="logo2">
              <img src="<?php echo e(asset('assets/footer-logo.png')); ?>" alt="" >
           </span>
        </span>
    </div>
</footer><?php /**PATH D:\server\htdocs\profitability-tool\resources\views/include/footer.blade.php ENDPATH**/ ?>