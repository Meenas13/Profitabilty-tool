        ...
        <div class="chat-list">
            <div class="list-group row">
                ...
                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Billy Black">
                    <figure class="user--online">
                        <img src="<?php echo e(asset('img/user2.jpg')); ?>" class="rounded-circle" alt="">
                    </figure><span><span class="name"><?php echo e(__('Billy Black')); ?></span>  <span class="username">@billyblack</span> </span>
                </a>
                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Herbert Diaz">
                    <figure class="user--online">
                        <img src="<?php echo e(asset('img/user3.jpg')); ?>" class="rounded-circle" alt="">
...
</div><?php /**PATH F:\xampp\htdocs\profitability-tool\resources\views/include/chat.blade.php ENDPATH**/ ?>