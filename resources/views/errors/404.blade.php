                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <a class="navbar-brand" href="index.html" alt="Home" title="home">
                            <img src="{{ asset('assets/BSC_Main_Logo.png') }}" alt="">
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="box-container my-5 text-center align-items-center">
                        ...
                        <img src="{{ asset('assets/404_error.webp') }}" class="img-fluid img-vector-box" alt="  ">
                        <h4 class="text-warning font-bolder">Uh Ohh! you lost your way</h4>
                        <p>The page you are looking for doesn't exist</p>
                        <div class="d-inline btn-row">
                            <a href="{{ route('customer') }}"><div class="btn btn-primary">Go Home</div></a>
