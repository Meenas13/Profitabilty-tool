        ...
        <div class="col-xl-4 col-md-6">
            <div class="card new-cust-card">
                ...
                <div class="card-block">
                    ...
                    <div class="align-middle mb-25">
                        <img src="{{ asset('img/user2.jpg')}}" alt="user image" class="rounded-circle img-40 align-top mr-15">
                        <div class="d-inline-block">
                            <a href="#!">
                                <h6>{{ __('John Doue')}}</h6>
                            </a>
                    ...
                    <div class="align-middle mb-25">
                        <img src="{{ asset('img/user3.jpg')}}" alt="user image" class="rounded-circle img-40 align-top mr-15">
                        <div class="d-inline-block">
                            <a href="#!">
                                <h6>{{ __('Alex Thompson')}}</h6>
                            </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ __('HeadPhone')}}</td>
                                    <td><img src="{{asset('img/widget/p1.jpg')}}" alt="" class="img-fluid img-20"></td>
                                    <td>
