                                ...
                                <?php if (!empty($avgData2)) { ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>{{$value2->sales}}</td>
                                            <td>{{$value2->oti}}%</td>
                                            <td>{{$value2->invoice_id}}</td>
                                        </tr>
                                    <?php }  ?>
                                    <tr>
                                        <td>Last 12 Months - Excl Under Avg</td>
                                        <td>{{$avgSales-$Sales}}</td>
                                        <td>{{$avgOTI-$OTI}}%</td>
                                        <td>{{$avgInvoice_id-$Invoice_id}}</td>
                                    </tr>
                                <?php }  ?>
                            </tbody>
                        </table>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input select_all_child" id="" name="customer-id" value="{{$value->ID}}">
                                                <span class="custom-control-label">&nbsp;</span>
                                            </label>
                                        </td>
                                        <td>{{$value->buy_domain_no}}</td>
                                        ...
                                        <td>{{round($value->sales/$rand)}}</td>
                                        <td>{{round($value->colli/$rand)}}</td>
                                        <td>{{round($value->invoice_id/$rand)}}</td>
                                    </tr>
                            <?php }
                            } ?>
